...
| `Meshuttle-1.1.0-Android.apk` | 正式签名 Android APK |
...
- Android 正式长期分发必须使用稳定保存的发布密钥；发布流程在密钥缺失时会停止，不会上传测试签名 APK。
- 官方 Android APK 签名证书 SHA-256：`AB:42:7B:6E:79:AA:CD:55:78:98:94:37:EA:52:B0:1C:A9:B6:EB:FF:42:11:2C:8A:41:55:EE:D5:E6:AF:18:51`。
